...
; //                                                                                                                           *
; //This file is part of the software program  itoa".                                                                   *
; / itoa is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License   *
; //version 3 as published by the Free Software Foundation.                                                                    *
; / itoa is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied          *
...
; //   Compile: nasm -f elf64 -l itoa.lis -o itoa.o itoa.asm 
; //   Linker: ld -o final.out _start.o strlen.o cosine.o _math.o itoa.o ftoa.o stringtof.o 
; //
; //=======1=========2=========3=========4=========5=========6=========7=========8=========9=========0=========1=========2=========3**
; //
; //
